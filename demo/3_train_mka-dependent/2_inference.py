...
def main() -> int:
    ...
    ap.add_argument("--checkpoint", "-c", default="0_16_best_w32_lr0.0003_bs8.pth", help="Path to .pth checkpoint produced by training script.")
    ap.add_argument("--image", "-i", default="hlenovo5.png", help="Path to spectrogram image file OR directory of images.")
    ap.add_argument("--device", default=None, help="Override device: cpu | cuda | mps (or torch device string).")
    ap.add_argument("--topk", type=int, default=5, help="Print top-k predictions (default: 1).")
    args = ap.parse_args()
